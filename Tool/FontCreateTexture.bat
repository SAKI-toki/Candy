...
set FONT_TEXTURE_PATH=D:\Candy\RawData\Font\Texture\%2.png
...
D:\Candy\Tool\Texture\texconv.exe -ft dds -w 2048 -h 2048 -m 1 -f BC3_UNORM -y -o %OUTPUT_PATH%  %FONT_TEXTURE_PATH%
