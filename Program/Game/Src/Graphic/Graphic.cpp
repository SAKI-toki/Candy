...
void Graphic::Startup()
{
	...
	VertexInfo vertices[] =
	{
		{ { -0.25f, +0.25f, 0.0f }, CANDY_COLOR_RGB32(0xff, 0xa5, 0x00) }, // ¶ã
		{ { +0.25f, +0.25f, 0.0f }, CANDY_COLOR_RGB32(0x00, 0x00, 0xff) }, // ‰Eã
		{ { -0.25f, -0.25f, 0.0f }, CANDY_COLOR_RGB32(0xbb, 0x00, 0x00) }, // ¶‰º
		{ { +0.25f, -0.25f, 0.0f }, CANDY_COLOR_RGB32(0xbb, 0xbb, 0xbb) }, // ‰E‰º
	};
