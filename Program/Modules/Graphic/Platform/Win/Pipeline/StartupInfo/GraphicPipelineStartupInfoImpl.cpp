...
namespace impl
{
	...
	void PipelineStartupInfoImpl::setRenderTaretFormat(const s32 _index, const types::GRAPHIC_FORMAT _graphicFormat)
	{
	...
	void PipelineStartupInfoImpl::setDepthStencilFormat(const types::GRAPHIC_FORMAT _graphicFormat)
	{
		m_StartupInfo.DSVFormat = ConvGraphicFormat(_graphicFormat);
	}

	void PipelineStartupInfoImpl::setInputLayoutElement(const s32 _index, const types::SHADER_SEMANTIC_TYPE _shaderSemanticType,
	...
	void PipelineStartupInfoImpl::setFillMode(const types::FILL_MODE _fillMode)
	{
