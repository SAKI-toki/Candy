...
namespace Graphic
{
	void Buffer::startupRenderTarget(const Device& _device, const GRAPHIC_FORMAT _graphicFormat, const s32 _width, const s32 _height)
	{
		BufferImpl::startupRenderTarget(_device.getDevice(), _graphicFormat, _width, _height);
	}
