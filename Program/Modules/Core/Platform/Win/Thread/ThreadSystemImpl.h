...
#ifndef CANDY_CORE_THREAD_SYSTEM_IMPL_H
#define CANDY_CORE_THREAD_SYSTEM_IMPL_H

#include <Core/CoreInclude.h>

#include <Core/Thread/ThreadDef.h>
#include <Core/Thread/ThreadHandle.h>
...
#endif // CANDY_CORE_THREAD_SYSTEM_IMPL_H
